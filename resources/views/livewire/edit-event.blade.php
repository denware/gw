				...
				<form wire:submit="update">
					...
					<div class="grid grid-cols-4 gap-8 mb-8 ">
						...
						<div class="font-black flex flex-row"><label class="self-center">Kezdete:</label></div>   			<div class="col-span-3">
								<div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
								<input type="text" name="start" id="start" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Kezdete" value="{{ $event->start }}" wire:model="form.start">
							</div>					
						</div>
						<div class="font-black flex flex-row"><label class="self-center">Vége:</label></div>   				
						<div class="col-span-3">
							<div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
								<input type="text" name="end" id="end" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Vége" value="{{ $event->end }}" wire:model="form.end">
							</div>						
						</div>
						<div class="font-black flex flex-row"><label class="self-center">Jegyek:</label></div>   	
						<div class="col-span-3">
							<div class="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
								<input type="text" name="seats" id="seats" class="block min-w-0 grow py-1.5 pr-3 pl-1 text-base text-gray-900 placeholder:text-gray-400 focus:outline-none sm:text-sm/6" placeholder="Jegyek" value="{{ $event->seats }}" wire:model="form.seats">
