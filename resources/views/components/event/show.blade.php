...
<div class="grid grid-cols-4 gap-4">
	...
	<div class="font-black">Típus:</div>   				<div class="col-span-3">{{ $event->name }}</div>
    ...
    <div class="font-black">Vége:</div>   				<div class="col-span-3">{{ DateTime::createFromFormat('Y-m-d H:i:s',$event->stop)->format('H:i') }}</div>
